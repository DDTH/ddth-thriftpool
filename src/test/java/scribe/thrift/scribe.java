...
public class scribe {
	...
	public static class Client extends
			com.facebook.fb303.FacebookService.Client implements Iface {
	...
	public static class AsyncProcessor<I extends AsyncIface> extends
		...
		public static class Log<I extends AsyncIface> extends
			...
			public AsyncMethodCallback<ResultCode> getResultHandler(
	...
	public static class Log_args implements
			...
			java.io.Serializable, Cloneable, Comparable<Log_args> {
						...
						if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
							{
								org.apache.thrift.protocol.TList _list0 = iprot
										.readListBegin();
								struct.messages = new ArrayList<LogEntry>(
										_list0.size);
	...
	public static class Log_result implements
			...
			java.io.Serializable, Cloneable, Comparable<Log_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"Log_result");
				...
				while (true) {
					...
					case 0: // SUCCESS
						if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
							struct.success = ResultCode.findByValue(iprot
									.readI32());
